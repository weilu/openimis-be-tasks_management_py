    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('RECEIVED', 'RECEIVED'), ('ACCEPTED', 'ACCEPTED'), ('COMPLETED', 'COMPLETED'), ('FAILED', 'FAILED')], default='RECEIVED', max_length=100)),
                ('complete_action', models.CharField(max_length=200)),
                ('business_status', models.JSONField()),
                ('business_event', models.CharField(max_length=200)),
